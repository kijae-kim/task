...
# FPS 값이 유효한지 확인
if fps == 0:
    print("Error: FPS value is zero. Please check the video file.")
    exit()
...
# 출력 설정
output_folder = '/Users/gimgijae/Desktop/KDT/CV/절도포착/timestamps/'
...
# 알림 소리 파일 경로
alarm_sound_path = '/Users/gimgijae/Desktop/KDT/CV/절도포착/warning.wav'  # WAV 파일 권장
...
with open(timestamp_file_path, 'w') as timestamp_file:
    ...
    while cap.isOpened():
        ...
        for track in root.findall('.//track'):
            ...
            # 필요한 관절만 처리
            if label in skeleton_connections.keys() or label in [item for sublist in skeleton_connections.values() for item in sublist]:
